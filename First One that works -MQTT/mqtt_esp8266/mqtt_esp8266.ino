...
/*Next tests:
 * connect to Kyle's computer from home (if not, look into this code to see how to get out of local network)
 * connect to AWS (if not, then something at AWS is preventing it)
*/
...
//const uint8_t mqtt_server[] = {172, 30, 49, 78}; //Kyle local computer in eLab
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("ESP8266Client")) {
      ...
      client.publish("fitai", "hello world"); //outTopic
      // ... and resubscribe
